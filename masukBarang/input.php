...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header">Kelola Barang Masuk</h1>
    </div>
    <!-- /.col-lg-12 -->
  </div>
			...
			<div class="card">
				<div class="card-body">
                        <form action="?act=prosesMasuk" method="POST">                           
							<div class="form-group row">
								...
								<div class="col-sm-5">
									<select class="form-control" name="kode">
										...
										<?php
											$sql  = "SELECT DISTINCT(kode) as kode FROM stok where toko='$toko' order by kode asc";
							...
							<div class="form-group row">
								...
								<div class="col-sm-5">
									<input class="form-control" placeholder="Masukkan Nama Lemari" name="lemari" type="text" required>
								</div>
							</div>				
							<div class="form-group row">								
								<div class="col-sm-5">
                                ...
                                <button type="submit" class="btn btn-info pull-left" id="simpan" name="simpan">Simpan</button>
